...
select s.buy_in + ifnull(s.bounty,0) + s.entry_fee + ifnull(s.rebuys,0) + ifnull(s.add_on,0) wagered,
s.winnings,s.delta,concat(s.poker_session_date,s.tournament_letter) date,
